...
export const priceGroups: PriceGroup[] = [
  ...
  },
  {
    ...
    "items": [
      ...
      {
        "label": "Кръстове — с надпис, според модела",
        "note": "от €25"
      },
      {
      ...
      {
        "label": "Траурни шалчета",
        "price": 5
      },
      {
        "label": "Драперия за ковчег",
        "price": 40
      },
      {
        "label": "Одеяло",
      ...
      {
        "label": "Керамичен фенер — отворена ниша (теракота, кафяв, бял)",
        "price": 15
      },
      {
        "label": "Керамичен фенер — стъклена вратичка (теракота, кафяв, бял)",
        "price": 15
      },
      {
        "label": "Метален фенер с орнаменти и стъкло (бял)",
        "price": 15
      },
      {
        "label": "Метален фенер на прът, факла (4 цвята)",
        "price": 25
      },
      {
        "label": "Стойка за скръбна вест",
        "price": 25
      }
    ]
  },
