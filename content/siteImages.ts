...
export const siteImages: Record<string, SiteImage> = {
  ...
  "kovcheg-02": img({
    id: "kovcheg-02",
    alt: "Дървен ковчег с вътрешна тапицерия",
    category: "coffins",
    usage: "catalog",
    pages: ["/traurni-stoki"],
    aspect: "landscape",
  ...
  "kovcheg-03": img({
    id: "kovcheg-03",
    alt: "Модел ковчег от каталога на АМИН",
    category: "coffins",
    usage: "catalog",
    pages: ["/traurni-stoki"],
    aspect: "landscape",
  ...
  "kovcheg-05": img({
    id: "kovcheg-05",
    alt: "Дървен ковчег с бяла вътрешна тапицерия",
    category: "coffins",
    usage: "catalog",
    pages: ["/traurni-stoki"],
    aspect: "landscape",
  ...
  "kovcheg-07": img({
    id: "kovcheg-07",
    alt: "Дървен ковчег от каталога на АМИН",
    category: "coffins",
    usage: "catalog",
    pages: ["/traurni-stoki"],
    aspect: "landscape",
